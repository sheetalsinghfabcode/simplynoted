...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1697108283276.5796";
}
var input;
var input2;
var output;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1697193071179.3738";
}
var customerid2;
var firstPrice;
function AddCart({
  ...
  function onClickAddCartBtn() {
    let ab = [];
    if (selectedItem && selectedItem2 && cardName && cardPrice) {
      ab.push(selectedItem, selectedItem2, cardName, cardPrice);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(import_jsx_dev_runtime2.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "  w-full h-full gap-2 mt-8", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "buttonDiv pr-5 m-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("button", { className: "bg-[#001a5f] text-[#fff] p-3", onClick: () => onClickAddCartBtn(), children: "Add To Cart" }, void 0, false, {
      fileName: "app/components/products/AddCart.jsx",
      lineNumber: 302,
      columnNumber: 21
    }, this) }, void 0, false, {
...
_s2(AddCart, "izGqAhPMydNPcTOpaf/WRKRn6fE=", false, function() {
  return [useNavigate];
});
_c2 = AddCart;
var _c2;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1697193605189.584";
}
var input3;
var customerid3;
...
function Product() {
  ...
  const [name2, setName2] = (0, import_react9.useState)("");
  const [show, setShow] = (0, import_react9.useState)(false);
  const [productshow, setProductShow] = (0, import_react9.useState)(true);
  const [recipientAddress, setRecipientAddress] = (0, import_react9.useState)("");
  const [returnAddress, setReturnAddress] = (0, import_react9.useState)("");
  const [modalIsOpen, setIsOpen] = (0, import_react9.useState)(false);
  const [modalIsOpen2, setIsOpen2] = (0, import_react9.useState)(false);
  const [aiText, setaiText] = (0, import_react9.useState)("");
  const [valToGen, setValToGen] = (0, import_react9.useState)("");
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_jsx_dev_runtime3.Fragment, { children: productshow ? /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_jsx_dev_runtime3.Fragment, { children: [
    ...
    lineNumber: 525,
    columnNumber: 22
  }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(AddCart, { show, setProductShow, data, product }, void 0, false, {
    fileName: "app/routes/($locale).products.$productHandle.jsx",
    lineNumber: 661,
    columnNumber: 15
  }, this) }, void 0, false, {
...
exenv/index.js:
  ...
  *)
*/
//# sourceMappingURL=/build/routes/($locale).products.$productHandle-P7QJBLMV.js.map
