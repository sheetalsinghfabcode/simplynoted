...
function k({ children: e, action: t, inputs: r, route: a }) {
  let n = useFetcher();
  return (0, import_jsx_runtime8.jsxs)(n.Form, { action: a || "", method: "post", children: [(t || r) && (0, import_jsx_runtime8.jsx)("input", { type: "hidden", name: ke, value: JSON.stringify({ action: t, inputs: r }) }), typeof e == "function" ? e(n) : e] });
}
k.INPUT_NAME = ke;
...
*/
//# sourceMappingURL=/build/_shared/chunk-OBKVR3FN.js.map
