  ...
  return (
    <div className="w-full max-w-[1440px] mt-[24px] mx-auto px-[24px]">
      ...
      {loader ? (
        ...
        <div className="w-full p-[20px] max-w-[640px] mx-auto">
          <div
              ...
              <>
                ...
                <div className=" border-2 text-[12px] bg-white text-left p-[10px] border-solid border-[#324879]">
                  ...
                  <span>
                    ...
                    drops below $100 and to renew your subscription at the end
                    of your subscription period. Both your subscription and
                    prepaid package can be changed later from your Account area.
                  </span>
                </div>
              </>
            )}
