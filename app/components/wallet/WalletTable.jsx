          ...
          <div className="hidden md:block">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5  border-b border-gray-200">
              ...
              {pricingPlans.map((plan, index) => (
                <div
                  key={index}
                  className="py-2 px-4 min-w-[190px] flex flex-col text-center"
                >
                  <div className="flex flex-col font-karla py-[10px] px-[20px] flex-row-reverse items-center">
                    ...
                    <div
                      className={` text-[24px] xl:text-[36px] whitespace-nowrap my-2 text-[#000] ${
                  ...
                  <DynamicButton
                    ...
                    } mt-2 md:min-w-[360px] md:mx-auto  lg:mx-0 lg:min-w-0
