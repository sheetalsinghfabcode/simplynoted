...
const StripeCard = ({
  ...
  >
    {( !addCreditModal  )  ? 'Update Card' : (showStripeCard || addCreditModal ? 'Add Card' : (pathname.pathname === '/simply-noted-plans' || pathname.pathname === '/account' ? 'Complete Purchase' : 'Update Card'))}
  </button>
</div>
