      ...
      <div className="modal-container bg-white w-11/12 md:max-w-[60%] mx-auto rounded shadow-lg z-50 rounded-[10px] overflow-y-auto">
        <div className="modal-content py-4  px-6">
          <div className="modal-header">
            <h3 className=" md:text-[29px] text-[13px]  text-center leading-[1.4] w-full max-w-[418px] mx-auto text-[#001a5f] font-semibold">
              {title}
            </h3>
          </div>
          ...
          <div className="modal-footer w-full  md:flex grid justify-center items-center gap-[12px] mt-[20px]">
            <button
              onClick={onConfirm}
