          ...
          <div className="sm:text-[14px] text-[12px] flex flex-col items-center">
            ...
            <div className=" w-[100%]  text-justify">
              ...
              <p className="mt-[25px] ">
                ...
                the terms “we”, “us” and “our” refer to Simply Noted. Simply
                Noted offers this website, including all information, tools and
            ...
            <div className=" w-[100%]  text-justify">
              ...
              <p className="mt-[25px]">
                In no case shall Simply Noted, our directors, officers,
            ...
            <div className=" w-[100%]  text-justify">
              ...
              <p className="mt-[25px] ">
                You agree to indemnify, defend and hold harmless Simply Noted
            ...
            <div className=" w-[100%]  text-justify">
              ...
              <p className="mt-[25px] ">
                ...
                accordance with the laws of 123 S Street, Phoenix, AZ, 85018,
                United States.
              </p>
            </div>
            ...
            <div className=" w-[100%]  text-justify">
              ...
              <p className="mt-[25px] ">
                You are responsible for the accuracy of your order placed. Our
                orders consist of user entered personalized messages, custom
                fields, and addresses. We print and ship our orders according to
                this information. Any burden for inaccuracies of this
                information is not placed on us and you understand that we will
                print and ship orders as they are entered by you.
              </p>
            </div>
            ...
            <div className=" w-[100%]  text-justify">
              ...
              <p className="mt-[25px] ">
                All orders placed are final. Any changes to order information or
                order accuracy must be sent to Simply Noted within 24 hours of
                the order being placed. This includes order placed via the
                "Birthday Automation" regardless of the specified birthday date
                as well as any orders placed with a delayed "Shipping Date".
              </p>
            </div>
            ...
            <div className=" w-[100%]  text-justify">
              ...
              <p className="mt-[25px] ">
                Our prepaid packages are valid for a duration of 1 year from the
                date of purchase. After 1 year, we reserve the right to cancel
                any existing balance. The prepaid balance can be utilized
                through Simply Noted's web application or API tools as per the
                functionality and terms provided therein. It remains the
                customer's sole responsibility to monitor and use their balance
