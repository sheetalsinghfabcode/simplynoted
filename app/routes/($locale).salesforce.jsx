...
export default function Salesforce() {
  return (
    ...
    <div className="flex flex-wrap justify-center ml-auto lg:mr-0 mr-auto w-[90%]">
      ...
      <img className='h-[310px] ml-[-143px]' src="	https://simplynoted.com/cdn/shop/files/espiral.png?v=3800721941933214506"/>
        <img
      ...
      <div className='lg:flex justify-center grid'>
        ...
        <h2 className='w-[297px] text-center'>Sending a letter to 1 customer or 10,000 + customers. We’ve got you covered!</h2>
        </div>
        <div className='mt-14'>
        <img src="https://cdn.shopify.com/s/files/1/0275/6457/2777/files/calculator-why-3.png?v=1611260085"/>
        <h2 className='w-[341px] text-center'>Every handwritten card and envelope we produce is hand quality controlled to ensure the highest quality product possible.</h2>
        </div>
      </div>
