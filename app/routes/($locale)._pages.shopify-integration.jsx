...
//             </h2>
//           </div>
//           <p className="lg:text-[18px] text-[18px] text-black font-light xl:w-[94%] w-[100%] sm:leading-8 leading-6 lg:mt-0 mt-7  lg:text-justify sm:text-center text-justify">
...
//           <div className="lg:block hidden">
//             <div className="xl:text-[36px]  md:mb-[12px] mb-[5px] text-[22px] font-bold text-[#001A5F]">
//               Send one or send
...
//             <DynamicButton
//               text="INTEGRATE NOW"
//               className="btn1 lg:w-[100%] lg:mt-6 md:w-[26%] sm:w-[38%] w-[68%] lg:!text-[17px] md:text-[14px] text-[12px] lg:h-[10%]  h-full mt-[35px]"
//               onClickFunction={() =>
//                 (window.location.href =
...
//           <div className="xl:text-[37px] mb-[12px] text-center text-[32px] font-bold text-[#001A5F]">
//             Send one or send
//             <span className="font-beauty text-6xl font-bold">thousands</span>
//           </div>
//         </div>
...
//       <div className=" mt-[105px] hidden md:block">
//         <img
...
//           <div className="lg:block hidden">
//             <div className="xl:text-[37px] md:mb-[12px] mb-[5px] text-[22px] font-bold text-[#001A5F]">
//               Send one or send
//               <span className="font-beauty text-6xl font-bold">thousands</span>
//             </div>
//           </div>
...
//             <DynamicButton
//               text="INTEGRATE NOW"
//               className="btn1 lg:w-[100%] lg:mt-6 md:w-[26%] sm:w-[38%] w-[77%] lg:!text-[17px] md:text-[14px] text-[12px] lg:h-[10%]  h-full mt-[35px]"
//               onClickFunction={() =>
//                 (window.location.href =
//                   'https://zapier.com/developer/public-invite/27690/a14b419f142ef350556c85f9ccafe775/?context=4136105 ')
//               }
...
//               <DynamicButton
//                 text="INTEGRATE NOW"
//                 className="lg:w-[100%] lg:mt-6 md:w-[26%] sm:w-[38%] w-[100%] lg:!text-[17px] md:text-[14px] text-[12px] lg:h-[10%]  h-full mt-[35px]"
//                 onClickFunction={() =>
//                   (window.location.href =
