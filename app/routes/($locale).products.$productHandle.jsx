...
export default function Product() {
  ...
  async function  processInput() {
    ...
    output.style.fontSize = '70px'; // Default font size
    resize_to_fit();
  }
  ...
  async function  processInput2() {
    ...
    output2.style.fontSize = '70px'; // Default font size
    resize_to_fit2();
  }
    ...
    <>
      <Section className="px-0 md:px-8 lg:px-12">
        ...
        <div className='mainDivForBox flex gap-10'>
          ...
          <div className='selectOtion mb-5 '>
            <Text>Standard Handwriting Style</Text>
          ...
          <textarea type="text" id="example-one-input" ref={ref} className='inputText' maxlength="450" placeholder="Enter your custom message text here..." data-gtm-form-interact-field-id="0"></textarea>
          <textarea type="text" id="example-one-input2" className='inputText2'maxlength="24"  placeholder="Enter here..." data-gtm-form-interact-field-id="0"></textarea>
