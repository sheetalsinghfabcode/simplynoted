      ...
      <div className="full-cont">
        <div className="pricing-Credit-Packs">
          ...
          <div className="Credit Packs text-center">
            <h1 className="text-blue-800 font-semibold lg:text-6xl text-[26px]">
              Credit Packs
            </h1>
            <h3 className=" mt-[18px] text-gray-700 font-thin lg:text-[19px] text-[15px] text-center ">
              Save time and money by pre purchasing credits. 1 credit equates to
              1 complete send.
            </h3>
          </div>
        ...
        <div className="sec-Transparency-cont lg:flex grid justify-center">
          <div className="left-cont">
            ...
            <div className=" Customizable-ntegrations grid md:grid-cols-3 grid-cols-2 md:gap-[23px] gap-[30px]">
              <div className="real-pen-notice w-[100%] ">
                <div className="circle-percentage">100%</div>
                ...
                <a
                  href="#"
                  className="absolute lg:left-[60px] left-[54px]  md:ml-[0px] lg:ml-[-31px] ml-[0px] lg:bottom-[36px] bottom-[56px]"
                >
                  Learn More →
                </a>
              </div>
              <div className="real-pen-notice w-[100%]">
                ...
                <a
                  href="#"
                  className="absolute lg:left-[41px] left-[61px] lg:bottom-[36px] bottom-[58px]"
                >
                  Learn More →
                </a>
              </div>
              <div className="real-pen-notice w-[100%]">
                ...
                <a
                  href="#"
                  className="absolute lg:left-[41px] left-[52px] lg:bottom-[36px] bottom-[59px]"
                >
                  Learn More →
                </a>
              </div>
              <div className="real-pen-notice w-[100%]">
                ...
                <a
                  href="#"
                  className="absolute lg:left-[41px] left-[57px] lg:bottom-[36px] bottom-[62px]"
                >
                  Learn More →
                </a>
              </div>
              <div className="real-pen-notice w-[100%]">
                ...
                <a
                  href="#"
                  className="absolute lg:left-[41px] left-[53px] lg:bottom-[36px] bottom-[59px]"
                >
                  Learn More →
                </a>
              </div>
              <div className="real-pen-notice w-[100%]">
                ...
                <a
                  href="#"
                  className="absolute lg:left-[41px] left-[58px] lg:bottom-[36px] bottom-[59px]"
                >
                  Learn More →
                </a>
              </div>
          ...
          <div className="right-cont relative p-[58px]">
            ...
            <div className="flex flex justify-center mb-[22px] gap-[27px] mt-[12px]">
              <div className="w-[69px]  text-center text-xs">
                Number of Cards
              </div>
            ...
            <img
              className="w-full"
              src="https://simplynoted.com/cdn/shop/files/pricing-table-underline.png"
            />
            ...
            <button
              className="bg-rose-500 mt-[12px] p-[11px] text-white w-full"
              type="button"
            >
              START ORDER
            </button>
